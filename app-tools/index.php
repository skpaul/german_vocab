...
<html>
    ...
    <body>
        <div class="container" style="max-width: 670px;">
                ...
                <a href="crypto.php?<?=$queryString ?>" target="_blank"><img src="images/validables.png" style="height: 24px; margin-right: 10px;">Crypto</a>
                <a href="change-token.php?<?=$queryString ?>" target="_blank"><img src="images/token.png" style="height: 24px; margin-right: 10px;">Token</a>
                <a href="dyna-form.php?<?=$queryString ?>" target="_blank"><img src="images/sql.png" style="height: 24px; margin-right: 10px;">Data</a>
        </div>
