...
$disallowed_patterns = ['file-man.php','CONSTANTS.php'];  // must be an array.  Matching files not allowed to be uploaded

// $hidden_patterns = ['*.php','.*']; // Matching files hidden in directory index
$hidden_patterns = []; // Matching files hidden in directory index

$PASSWORD = 'Win123';  // Set the password, to access the file manager... (optional)
